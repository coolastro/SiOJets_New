...
obtain SiO emission maps, spectra and position-velocity (PV) digrams.}
  % results heading (mandatory)
   {Our model can successfully explain the signatures of extremely high
     ...
     EHV emission. In addition, the Atacama Large Millimeter Array (ALMA) predictions for such
...
of the lobes (\citealt{Masson:1992p14101}). The jet driven models could successfully
...
\begin{figure*}
 ...
 \caption{Fraction of hydrogen species, temperature and mean molecular
    weight in the run with molecular
