...
these line ratios. 
In the non-LTE (non local thermodynamic equilibrium) radiative transfer modeling, no assumption of optical
...
of axisymmetric jet propogation model with molecular cooling and
non-LTE radiative transfer calculations can sucessfully predict most
of the observed properties of SiO emission from young molecular
outflows from Class 0 stages. This model provides an excellent
template to compare current ALMA obervations and can also predict
signatures of thermal instabilities which can be tested with upcoming
ALMA observations. In future, we would like to extent our
model to full three dimensions and evolve the jet for longer time
scales to explore slow velocity component, precession and 
slew of other instabilities. Additionally, we would also like to have
