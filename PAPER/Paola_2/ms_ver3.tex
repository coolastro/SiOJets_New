...
\author[B. Vaidya, T. Douglas, P. Caselli]{Bhargav Vaidya$^{1}$\thanks{E-mail:
B.Vaidya@leeds.ac.uk (BV)}, Thomas Douglas$^{1}$, Paola Caselli$^{1}$\\
...
code. The jet dynamical quantities evolve in conjunction
with different non-equilibrium cooling prescriptions of varying
complexities, including molecular cooling along and
...
obtain SiO emission maps, spectra and position-velocity (PV) digrams.}
  % results heading (mandatory)
   {Our model can successfully explain the signatures of extremely high
     ...
     early molecular outflows show bright emission coming from young
     internal knots and bow shocks due to thermal
     ...
     regions closer to the axis of the jet. The dependence of emission on
...
10$^{-7}$). Inspite of such over estimated abundance values, their
...
\begin{figure}
 ...
 \caption{{\it{Left}}: Colour composite image of various hydrogen
...
%\it{Top}: Number density,  obtained from the reference run along with labels of typical jet features.}
...
\begin{figure*}
 ...
 \caption{Integrated intensity maps of SiO(2-1) line in units of K, for runs with molecular
...
\begin{figure*}
 \includegraphics[width=2.\columnwidth]{\figpath/pfig12.pdf}%almamaps_new.pdf}%{\figpath/ALMAmaps3.png}
