...
in turn the computations are less expensive especially considering the stiff 
rate equations used to model cooling in flows. 
...
case. In case of L1448, \cite{MartinPintado:1992p14309}
...
regions with processed velocities (i.e, jet interface), however, 
