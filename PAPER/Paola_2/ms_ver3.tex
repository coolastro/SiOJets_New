...
\begin{figure*}
 ...
 \caption{{\textit{Top}}: Number density, n$_\rm H$ [cm$^{-3}$], obtained from the reference run along with labels of typical jet features.{\textit{Bottom}}: Dependence of hydrogen fractions on the temperature at two
