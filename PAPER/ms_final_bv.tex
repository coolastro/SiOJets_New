...
The evolution of chemical abundances for each spiecies is solved via,
%
...
given spiecies through chemical reactions (see Sect.~\ref{sec:chem}).
...
Describe initial condition - Geometry, domian size, boundary
conditions\\
Physical motivation of initial condition.\\
\section{Chemistry and Cooling}
\label{sec:chem}
Atomic Cooling\\
Molecular cooling fixed abundance -- Tabulated Cooling\\
Molecular cooling with chemistry. \\
Mention briefly Adiabatic and Powerlaw cooling.

\begin{table*}
\begin{minipage}{\textwidth}
\caption{Summary of the chemistry reaction set. T is the temperature
  in Kelvin, $T_{\rm eV}$ is the tempeature in electron-volts, $T_{5}$
  = $T/1\times10^{5}$  and 
$T_{2}$  = T/100}
\begin{tabular}{l l l l}
\hline
No. & Reaction & Rate Coeff ($\rm {cm}^{3} s^{-1}$) &
...
\begin{figure}
 ...
 \caption{The polynomial used to calculate an abundace of SiO as a function of local velocity.}
 \label{abun}
\end{figure}
