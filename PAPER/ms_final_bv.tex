...
the shocks due to internal knots. These high level transitions
also show an evidence of sub-structure close to the primary bow shock.
Such a trend in emission with excitation energies coming from different SiO line transitions
...
indicated from observations. In summary, the
...
\subsection{Caveats and Steps Ahead}
Better handle on Molecular fraction in jets.\\
Zero order approximation of SiO fractional abundance profile.\\ 
Since SiO in gas phase for 0 years with our abundance. While SiO takes
10$^{4}$ years. History of SiO in gas phase and proper chemistry to get
abundance. 

Wider CO and H2O WISH survey component.\\
