...
independently without dynamics using plane parallel shock
models \citep{Schilke:1997p14140,Flower:2003p11236} . The magneto-hydrodynamic (MHD) calculations by \cite{Glassgold:1991p13703} suggested that molecules
...
\cite{Panoglou:2012p10039}. Very limited simulations have modelled the outflow
...
CO, OH etc. Figure~\ref{fig:Hfracsim} shows the density of
various hydrogen species in the outflow. Also shown in the figure is
the temperature and mean molecular weight $\mu$. As the jet propgates
into the medium 


figure nos. 2 --> Explain molecular cooling in more details. With the
mechanism of formation and destruction of HI, H2 and HII using
figures. 
\begin{figure*}
...
\begin{figure}
 \includegraphics[width=1.\columnwidth]{\figpath/EM_diffabun.png}
...
\begin{figure}
 \includegraphics[width=1.\columnwidth]{\figpath/contourmapsSiOTopHat.png}
 \caption{Contours of SiO 2-$>$1 and 8-$>$7 emission obtained using the
   SiO Top Hat profile.}
\label{grid}
\end{figure}
...
\begin{figure}
 \includegraphics[width=1.\columnwidth]{\figpath/PV_diffabun.png}
 \caption{Variation of position-velocity diagram for 2-$>$1 SiO emission for runs with molecular
   cooling having $\eta$ = 3 and $\beta$ = 10 and different abundance profiles.}
\label{grid}
\end{figure}
...
Lower $\eta$ gives better emission.  
...
a signature feature of jet driven molecular outflows. Counterparts in observations.
...
As seen by Chandler \& Richer 2001 and Hirano 2006.
\begin{figure*}
...
\begin{figure}
 \includegraphics[width=1.\columnwidth]{\figpath/LineRatio_TH_60_Y205.png}
