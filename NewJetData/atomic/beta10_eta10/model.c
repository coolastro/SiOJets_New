 ...
 */
  ...
  img[3].filename		= "image_J5-4_60deg_molcool.fits";	// Output filename
}
/******************************************************************************/
...
density(double x, double y, double z, double *density){	
  ...
  if ((R>(arr_size_R-1)) || (Z>(arr_size_Z-1)) || (R<0) || (Z<0)) {density[0]=rho[arr_size_R-1][arr_size_Z-1]*unit_density*fneut[arr_size_R-1][arr_size_Z-1];}
